...
const APPS = [
    ...
    /*     {
            ...
            icon: '<circle cx="16" cy="8" r="4" fill="none" stroke="black" stroke-width="2"/><path d="M6 28 C6 22 10 18 16 18 C22 18 26 22 26 28 Z" fill="none" stroke="black" stroke-width="2"/><text x="16" y="13" font-size="6" text-anchor="middle" fill="black" stroke="none">?</text>'
        }, */
    {
        id: 'anagrams',
        name: 'Anagrams',
