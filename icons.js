...
const APPS = [
    ...
    },
    {
        ...
        name: 'Comics',
        cat: 'lifestyle',
        desc: 'Read public domain comics.',
    ...
    },
    {
        ...
        filled: true,
        new: true,
        icon: '<path d="M16 16 L25.8 9.1 A12 12 0 1 0 25.8 22.9 Z" fill="black" stroke="none"/><circle cx="29" cy="16" r="1.5" fill="black"/>'
    },
    {
        id: 'dino',
        name: 'Dino',
    ...
    /*     {
            ...
            filled: true,
            new: true,
            icon: '<rect x="3" y="26" width="26" height="3" fill="black"/><rect x="12" y="8" width="8" height="3" fill="black"/><rect x="10" y="11" width="12" height="7" fill="black"/><rect x="12" y="18" width="8" height="2" fill="black"/><rect x="12" y="13" width="2" height="2" fill="white"/><rect x="18" y="13" width="2" height="2" fill="white"/><rect x="12" y="20" width="2" height="3" fill="black"/><rect x="18" y="20" width="2" height="3" fill="black"/><rect x="6" y="4" width="4" height="2" fill="black"/><rect x="22" y="6" width="4" height="2" fill="black"/>'
        }, */
    {
        id: 'surfer',
        name: 'Surfer',
        cat: 'games',
        new: true,
        icon: '<circle cx="19" cy="6" r="3"/><path d="M17 10 L12 17 L7 15 M12 17 L16 22 L14 28 M12 17 L8 22 L4 25 M17 11 L23 14"/>'
    },
    {
        id: 'cubedash',
        name: 'Cube Dash',
